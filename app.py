...
# --- CONFIGURATION ---
# This sets the page title and icon
...
# --- DAILY QUOTE LOGIC ---
# A small database of quotes that rotates based on the day of the year
quotes = [
...
# Pick a quote based on the current day number so it changes every 24h
...
if "messages" not in st.session_state:
    ...
    # THE SYSTEM PROMPT FROM YOUR UPLOADED FILE
    system_prompt = """
